                ...
                <div class="row second-row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">   
                        ...
                        <div id="records" class="message-div">
                            <form method="post" action="?controller=pages&action=settings&subpage=gallerypagesettings&part=update" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                        ...
                                        <input class="input-class form-control" type="text" name="pageTitle" id="pageTitle" value="<?php echo $pageSettings["Title"]; ?>" readonly="readonly"/>
                                </div>
                                <div class="form-group">
